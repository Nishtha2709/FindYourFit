...
class _SmallScreenInputState extends State<SmallScreenInput> {
  ...
  Widget build(BuildContext context) {
    ...
    Future openCamera() async {
      ...
      setState(() {
        mySmallImage = File(cameraImage.path);
      });
    }
    ...
    Future openGallery() async {
      ...
      setState(() {
        mySmallImage = File(galleryImage.path);
      });
    }
                  ...
                  children: <Widget>[
                    ...
                    MaterialButton(
                      ...
                      onPressed: () {
                        ...
                        uploadImageToServer(mySmallImage, '2');
      ...
      Widget build(BuildContext context) {
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text("Garment Size: S"),
          ),
          body: Container(
            child: mySmallImage == null
                ? Center(
                    child: Text(

...
class _MediumScreenInputState extends State<MediumScreenInput> {
  ...
  Future openCamera() async {
    ...
    setState(() {
      medium_size = File(cameraImage.path);
    });
  }
  ...
  Future openGallery() async {
    ...
    setState(() {
      medium_size = File(galleryImage.path);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    uploadImageToServer(File imageFile,String id) async {
      ...
      var multipartFile = new http.MultipartFile('medium_size', stream, length,
              ...
              child: ListBody(
                children: <Widget>[
                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      uploadImageToServer(medium_size,'2');

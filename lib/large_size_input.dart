...
class LargeScreenInput extends StatefulWidget {
  @override
  _LargeScreenInputState createState() => _LargeScreenInputState();
}

class _LargeScreenInputState extends State<LargeScreenInput> {
  @override
  Widget build(BuildContext context) {
    ...
    Future openCamera() async {
      ...
      setState(() {
        myLargeImage = File(cameraImage.path);
      });
    }
    ...
    Future openGallery() async {
      ...
      setState(() {
        myLargeImage = File(galleryImage.path);
      });
    }
                  ...
                  children: <Widget>[
                    ...
                    MaterialButton(
                      ...
                      onPressed: () {
                        ...
                        uploadImageToServer(myLargeImage, '2');
      ...
      Widget build(BuildContext context) {
        return Scaffold(
          appBar: AppBar(
            ...
            title: Text("Garment Size: L"),
          ),
          body: Container(
            child: myLargeImage == null
                ? Center(
              child: Text(
